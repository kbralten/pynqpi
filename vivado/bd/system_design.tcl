...
proc create_root_design { parentCell } {
  ...
  set_property -dict [list \
    ...
    CONFIG.PCW_FPGA1_PERIPHERAL_FREQMHZ {75.25} \
...
\
  ...
  # Create instance: axis_to_video_0, and set properties
  set block_name axis_to_video
  set block_cell_name axis_to_video_0
  if { [catch {set axis_to_video_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $axis_to_video_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property CONFIG.STREAM_WIDTH {32} $axis_to_video_0


  # Create instance: pixelclk_reset_0, and set properties
  set pixelclk_reset_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 pixelclk_reset_0 ]
  ...
  connect_bd_intf_net -intf_net axi_smc_M02_AXI [get_bd_intf_pins axi_smc/M02_AXI] [get_bd_intf_pins v_tc_0/ctrl]
  connect_bd_intf_net -intf_net axi_vdma_0_M_AXIS_MM2S [get_bd_intf_pins axi_vdma_0/M_AXIS_MM2S] [get_bd_intf_pins axis_to_video_0/s_axis]
  ...
  connect_bd_net -net axis_to_video_0_vid_active_video  [get_bd_pins axis_to_video_0/vid_active_video] \
  [get_bd_pins rgb2dvi_0/vid_pVDE]
  connect_bd_net -net axis_to_video_0_vid_data  [get_bd_pins axis_to_video_0/vid_data] \
  [get_bd_pins rgb2dvi_0/vid_pData]
  connect_bd_net -net axis_to_video_0_vid_hsync  [get_bd_pins axis_to_video_0/vid_hsync] \
  [get_bd_pins rgb2dvi_0/vid_pHSync]
  connect_bd_net -net axis_to_video_0_vid_vsync  [get_bd_pins axis_to_video_0/vid_vsync] \
